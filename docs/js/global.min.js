...
"document"in self&&("classList"in document.createElement("_")&&(!document.createElementNS||"classList"in document.createElementNS("http://www.w3.org/2000/svg","g"))?!function(){var e=document.createElement("_");if(e.classList.add("c1","c2"),!e.classList.contains("c2")){var t=function(e){var t=DOMTokenList.prototype[e];DOMTokenList.prototype[e]=function(e){var r,n=arguments.length;for(r=0;r<n;r++)e=arguments[r],t.call(this,e)}};t("add"),t("remove")}if(e.classList.toggle("c3",!1),e.classList.contains("c3")){var r=DOMTokenList.prototype.toggle;DOMTokenList.prototype.toggle=function(e,t){return 1 in arguments&&!this.contains(e)==!t?t:r.call(this,e)}}e=null}():!function(e){if("Element"in e){var t="classList",r="prototype",n=e.Element[r],o=Object,i=String[r].trim||function(){return this.replace(/^\s+|\s+$/g,"")},a=Array[r].indexOf||function(e){for(var t=0,r=this.length;t<r;t++)if(t in this&&this[t]===e)return t;return-1},d=function(e,t){this.name=e,this.code=DOMException[e],this.message=t},s=function(e,t){if(""===t)throw new d("SYNTAX_ERR","An invalid or illegal string was specified");if(/\s/.test(t))throw new d("INVALID_CHARACTER_ERR","String contains an invalid character");return a.call(e,t)},l=function(e){for(var t=i.call(e.getAttribute("class")||""),r=t?t.split(/\s+/):[],n=0,o=r.length;n<o;n++)this.push(r[n]);this._updateClassName=function(){e.setAttribute("class",this.toString())}},c=l[r]=[],u=function(){return new l(this)};if(d[r]=Error[r],c.item=function(e){return this[e]||null},c.contains=function(e){return e+="",s(this,e)!==-1},c.add=function(){var e,t=arguments,r=0,n=t.length,o=!1;do e=t[r]+"",s(this,e)===-1&&(this.push(e),o=!0);while(++r<n);o&&this._updateClassName()},c.remove=function(){var e,t,r=arguments,n=0,o=r.length,i=!1;do for(e=r[n]+"",t=s(this,e);t!==-1;)this.splice(t,1),i=!0,t=s(this,e);while(++n<o);i&&this._updateClassName()},c.toggle=function(e,t){e+="";var r=this.contains(e),n=r?t!==!0&&"remove":t!==!1&&"add";return n&&this[n](e),t===!0||t===!1?t:!r},c.toString=function(){return this.join(" ")},o.defineProperty){var f={get:u,enumerable:!0,configurable:!0};try{o.defineProperty(n,t,f)}catch(p){p.number===-2146823252&&(f.enumerable=!1,o.defineProperty(n,t,f))}}else o[r].__defineGetter__&&n.__defineGetter__(t,u)}}(self))}(),texture=id("texture"),textureCtx=texture.getContext("2d"),body$$1=one("body"),filterBuilder=function(e){return div({className:"filter"},input({type:"checkbox",checked:!0,id:slugify$1(e),dataset:{filter:e},onmousedown:function(e){return e.stopPropagation()},onmouseup:function(e){return e.stopPropagation()},onchange:function(e){"Toutes les catégories"===e.target.getAttribute("data-filter")&&e.target.checked?all(".filter input:not(:checked)").forEach(function(e){return e.checked=!0}):"Toutes les catégories"!==e.target.getAttribute("data-filter")||e.target.checked?0===all(".filter input:checked").length?e.target.checked=!0:all('.filter input:checked:not([data-filter="Toutes les catégories"])').length<all('.filter input:not([data-filter="Toutes les catégories"])').length?one('[data-filter="Toutes les catégories"]').checked=!1:one('[data-filter="Toutes les catégories"]').checked=!0:e.target.checked=!0,filterData()}}),label({"for":slugify$1(e),onmousedown:function(e){return e.stopPropagation()},onmouseup:function(e){return e.stopPropagation()}},e))},modalBuilder=function(e){return div({className:"modal",id:"modal/"+slugify$1(e.title),dataset:{title:slugify$1(e.title)}},div({className:"modal-wrapper"},div({className:"modal-content"},h2(),article()),a({className:"modal-close",href:"#"},"Fermer")))},handleResize=throttle(function(e){scale=Math.max(1400,body$$1.offsetHeight,body$$1.offsetWidth),texture.width=scale,texture.height=scale,offsetLeft=(body$$1.offsetWidth-scale>>1)/scale,offsetTop=(body$$1.offsetHeight-scale>>1)/scale,fillTexture(!0)}),handleMousedown=function(e){body$$1.classList.contains("modal-opened")||1!==e.which||(clickTime=Date.now(),body$$1.classList.add("grabbing"),grabbing=!0,mx=e.pageX/scale,my=e.pageY/scale)},handleMousemove=function(e){if(!body$$1.classList.contains("modal-opened")&&1===e.which){if(grabbing){var t=e.pageX/scale-mx,r=e.pageY/scale-my;dx+=t,dy+=r}mx-=x,my-=y;var n=dataSet.find(function(e){return mx>e.area.left&&mx<e.area.right&&my>e.area.top&&my<e.area.bottom});body$$1.classList[n?"add":"remove"]("hover"),mx=e.pageX/scale,my=e.pageY/scale}},handleMouseup=function(e){if(!body$$1.classList.contains("modal-opened")&&1===e.which){if(mx=e.pageX/scale-x,my=e.pageY/scale-y,Date.now()-clickTime<150){var t=dataSet.reverse().find(function(e){return mx>e.area.left&&mx<e.area.right&&my>e.area.top&&my<e.area.bottom});t&&(document.location.href="#modal/"+t.slug),dataSet.reverse()}grabbing=!1,body$$1.classList.remove("grabbing")}},touchDown=function(e){handleMousedown({pageX:e.touches[0].pageX,pageY:e.touches[0].pageY,which:1})},touchMove=function(e){handleMousemove({pageX:e.touches[0].pageX,pageY:e.touches[0].pageY,which:1})},touchEnd=function(e){handleMouseup({pageX:e.touches[0].pageX,pageY:e.touches[0].pageY,which:1})},handleKeydown=function(e){if(!body$$1.classList.contains("modal-opened")&&"search"!==e.target.getAttribute("id")){switch(e.keyCode){case 38:dy+=.1;break;case 40:dy-=.1;break;case 39:dx-=.1;break;case 37:dx+=.1;break;case 9:void 0===selectedKnowledge?selectedKnowledge=0:(selectedKnowledge+=e.shiftKey?-1:1,selectedKnowledge<0&&(selectedKnowledge=dataSet.length-1),selectedKnowledge>dataSet.length-1&&(selectedKnowledge=0)),dx=.5+offsetLeft-dataSet[selectedKnowledge].area.left-.5*dataSet[selectedKnowledge].area.width,dy=.5+offsetTop-dataSet[selectedKnowledge].area.top-.5*dataSet[selectedKnowledge].area.height;break;case 32:case 13:document.location.href="#modal/"+dataSet[selectedKnowledge||0].slug}e.preventDefault(),e.stopPropagation()}},HandleShowFilter=function(e){e.stopPropagation();var t=one(".filters"),r=one(".filters-show");t.classList.contains("filters-shown")?(t.classList.remove("filters-shown"),r.classList.remove("filters-show--close")):(t.classList.add("filters-shown"),r.classList.add("filters-show--close"))},searchHandler=function(e){e.preventDefault(),initData(fullData)},addListeners=function(e){e?(body$$1.addEventListener("mousedown",handleMousedown),body$$1.addEventListener("mousemove",handleMousemove),body$$1.addEventListener("mouseup",handleMouseup),body$$1.addEventListener("touchstart",touchDown,!1),body$$1.addEventListener("touchmove",touchMove,!1),body$$1.addEventListener("touchend",touchEnd,!1),body$$1.addEventListener("keydown",handleKeydown),one(".filters-show").addEventListener("click",HandleShowFilter),one(".filters-show").addEventListener("mousedown",function(e){return e.stopPropagation()}),one(".filters-show").addEventListener("mouseup",function(e){return e.stopPropagation()}),one(".search").addEventListener("mousedown",function(e){return e.stopPropagation()}),one(".search").addEventListener("mouseup",function(e){return e.stopPropagation()}),one(".search").addEventListener("submit",searchHandler)):window.addEventListener("resize",handleResize)},distance=function(e,t,r,n){var o=e-r,i=t-n;return Math.sqrt(o*o+i*i)},drawSpiral=function(){dataSet.forEach(function(e,t){drawImage(t,e.sx,e.sy)})},drawImage=function(e,t,r){distance(t,r,-x,-y)<minDistanceDisplay&&dataSet[e].imageData&&(textureCtx.save(),textureCtx.translate(t*scale+x*scale,r*scale+y*scale),dataSet[e].area={left:t,top:r,right:t+dataSet[e].imageData.width/scale,bottom:r+dataSet[e].imageData.height/scale,width:dataSet[e].imageData.width/scale,height:dataSet[e].imageData.height/scale},textureCtx.drawImage(dataSet[e].imageData,0,0,dataSet[e].imageData.width,dataSet[e].imageData.height),textureCtx.restore())},initApp=function(){loadData().then(processData,logError),loadTexture()},loadData=function(){return new Promise(function(e,t){var r=new XMLHttpRequest;r.open("GET","data/data.json",!0),r.onload=function(){200===r.status?(fullData=JSON.parse(r.responseText),fullData.forEach(function(e){return e.categories.push("Toutes les catégories")}),e(fullData)):t(Error(r.statusText))},r.onerror=function(){t(Error("Network Error"))},r.send()})},logError=function(e){return console.log(e)},filterData=function(){initData(fullData,all(".filter input:checked").map(function(e){return e.getAttribute("data-filter")}))},initData=function(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:["Toutes les catégories"];dataSet=e.filter(function(e){return t.filter(function(t){return~e.categories.indexOf(t)}).length}),id("search").value.length&&(dataSet=search(id("search").value,dataSet,{keySelector:function(e){return e.title}})),imgsQty=e.length,dataSet.forEach(function(e,t){e.slug=slugify$1(e.title),e.index=t,e.area={left:0,top:0,right:0,bottom:0},body$$1.appendChild(modalBuilder(e))});for(var r=0,n=0,o=1,i=1,a=2*dataSet.length,d=0,s=0,l=void 0;d<a;){for(;2*r*o<i&&s!==dataSet.length;)r+=o,l=dataSet[s],l.sx=.3*r,l.sy=.3*n,s++;for(;2*n*o<i&&s!==dataSet.length;)n+=o,l=dataSet[s],l.sx=.3*r,l.sy=.3*n,s++;if(s===dataSet.length)break;o=-1*o,i+=1,d++}console.log("-----",search("esanc",dataSet,{keySelector:function(e){return e.title}}))},initModalAndRouter=function(){Modal(),(new Router).dispatch().extendRoute("#modal/:modalId",function(e,t){var r=dataSet.find(function(t){return t.slug===e});if(r&&(one('[data-title="'+r.slug+'"] h2').textContent=r.title,one('[data-title="'+r.slug+'"] article').innerHTML=r.text,selectedKnowledge=r.index,r.media)){var n=img({src:r.media});one('[data-title="'+r.slug+'"] article').insertBefore(n,one('[data-title="'+r.slug+'"] article').firstChild)}})},loadImagesBasedOnDistance=throttle(function(){dataSet.forEach(function(e){if(distance(e.sx,e.sy,-x,-y)<minDistanceLoad&&!e.imageData){var t=new Image;t.onload=function(t){e.imageData=t.target},t.src=e.image}else distance(e.sx,e.sy,-x,-y)>=minDistanceLoad&&e.imageData&&(e.imageData=null)})},200),processData=function(e){setFilters(e),initData(e),initModalAndRouter(),loadImagesBasedOnDistance(),addListeners(!0)},setFilters=function(e){e.map(function(e){return e.categories}).reduce(function(e,t){return e.concat(t)}).filter(function(e,t,r){return r.indexOf(e)===t}).sort().forEach(function(e){return one(".filters").appendChild(filterBuilder(e))})},loadTexture=function(){var e=new Image;e.onload=function(){texturePattern=textureCtx.createPattern(e,"repeat"),fillTexture(!0),render()},e.src="img/texture.jpg"},fillTexture=function(e){e&&(textureCtx.fillStyle=texturePattern),textureCtx.fillRect(-(x*scale),-(y*scale),scale,scale)},render=function t(){requestAnimationFrame(t),renderTexture(),loadImagesBasedOnDistance(),drawSpiral()},renderTexture=function(){x+=.1*(dx-x),y+=.1*(dy-y),textureCtx.save(),textureCtx.translate(x*scale,y*scale),fillTexture(),textureCtx.restore()},minDistanceDisplay=1,minDistanceLoad=2*minDistanceDisplay,texturePattern=void 0,imgsQty=void 0,fullData=void 0,dataSet=void 0,selectedKnowledge=void 0,scale=void 0,offsetTop=void 0,offsetLeft=void 0,grabbing=!1,dx=0,dy=0,x=0,y=0,mx=void 0,my=void 0,clickTime=void 0;handleResize(),addListeners(),initApp();