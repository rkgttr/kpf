...
const levenshteinSellers = (term, candidate)=> {
	if (term.length === 0) {
		return 1;
	}
...
const damerauLevenshteinSellers = (term, candidate)=> {
	if (term.length === 0) {
		return 1;
	}
...
const searchCore = (term, candidates, options)=> {
...
const createSearchItems = (items, options)=> {
