...
"document"in self&&("classList"in document.createElement("_")&&(!document.createElementNS||"classList"in document.createElementNS("http://www.w3.org/2000/svg","g"))?!function(){var e=document.createElement("_");if(e.classList.add("c1","c2"),!e.classList.contains("c2")){var t=function(e){var t=DOMTokenList.prototype[e];DOMTokenList.prototype[e]=function(e){var r,n=arguments.length;for(r=0;r<n;r++)e=arguments[r],t.call(this,e)}};t("add"),t("remove")}if(e.classList.toggle("c3",!1),e.classList.contains("c3")){var r=DOMTokenList.prototype.toggle;DOMTokenList.prototype.toggle=function(e,t){return 1 in arguments&&!this.contains(e)==!t?t:r.call(this,e)}}e=null}():!function(e){if("Element"in e){var t="classList",r="prototype",n=e.Element[r],o=Object,i=String[r].trim||function(){return this.replace(/^\s+|\s+$/g,"")},a=Array[r].indexOf||function(e){for(var t=0,r=this.length;t<r;t++)if(t in this&&this[t]===e)return t;return-1},d=function(e,t){this.name=e,this.code=DOMException[e],this.message=t},f=function(e,t){if(""===t)throw new d("SYNTAX_ERR","An invalid or illegal string was specified");if(/\s/.test(t))throw new d("INVALID_CHARACTER_ERR","String contains an invalid character");return a.call(e,t)},s=function(e){for(var t=i.call(e.getAttribute("class")||""),r=t?t.split(/\s+/):[],n=0,o=r.length;n<o;n++)this.push(r[n]);this._updateClassName=function(){e.setAttribute("class",this.toString())}},u=s[r]=[],l=function(){return new s(this)};if(d[r]=Error[r],u.item=function(e){return this[e]||null},u.contains=function(e){return e+="",f(this,e)!==-1},u.add=function(){var e,t=arguments,r=0,n=t.length,o=!1;do e=t[r]+"",f(this,e)===-1&&(this.push(e),o=!0);while(++r<n);o&&this._updateClassName()},u.remove=function(){var e,t,r=arguments,n=0,o=r.length,i=!1;do for(e=r[n]+"",t=f(this,e);t!==-1;)this.splice(t,1),i=!0,t=f(this,e);while(++n<o);i&&this._updateClassName()},u.toggle=function(e,t){e+="";var r=this.contains(e),n=r?t!==!0&&"remove":t!==!1&&"add";return n&&this[n](e),t===!0||t===!1?t:!r},u.toString=function(){return this.join(" ")},o.defineProperty){var p={get:l,enumerable:!0,configurable:!0};try{o.defineProperty(n,t,p)}catch(c){c.number===-2146823252&&(p.enumerable=!1,o.defineProperty(n,t,p))}}else o[r].__defineGetter__&&n.__defineGetter__(t,l)}}(self))}(),texture=id("texture"),textureCtx=texture.getContext("2d"),body$$1=one("body"),modalBuilder=function(e){return div({className:"modal",id:"modal/"+slugify$1(e.title),dataset:{title:slugify$1(e.title)}},div({className:"modal-wrapper"},div({className:"modal-content"},h2(),article()),a({className:"modal-close",href:"#"},"Fermer")))},handleResize=throttle(function(e){width=Math.max(1400,body$$1.offsetHeight,body$$1.offsetWidth),height=Math.max(1400,body$$1.offsetHeight,body$$1.offsetWidth),texture.width=width,texture.height=height,fillTexture(!0)}),handleMousedown=function(e){body$$1.classList.contains("modal-opened")||(clickTime=Date.now(),body$$1.classList.add("grabbing"),grabbing=!0,mx=e.pageX/width,my=e.pageY/height)},handleMousemove=function(e){if(!body$$1.classList.contains("modal-opened")){if(grabbing){var t=e.pageX/width-mx,r=e.pageY/height-my;dx+=t,dy+=r}mx-=x,my-=y;var n=dataSet.find(function(e){return mx>e.area.left&&mx<e.area.right&&my>e.area.top&&my<e.area.bottom});body$$1.classList[n?"add":"remove"]("hover"),mx=e.pageX/width,my=e.pageY/height}},handleMouseup=function(e){if(!body$$1.classList.contains("modal-opened")){if(mx=e.pageX/width-x,my=e.pageY/height-y,Date.now()-clickTime<150){var t=dataSet.reverse().find(function(e){return mx>e.area.left&&mx<e.area.right&&my>e.area.top&&my<e.area.bottom});t&&(document.location.href="#modal/"+t.slug),dataSet.reverse()}grabbing=!1,body$$1.classList.remove("grabbing")}},touchDown=function(e){handleMousedown({pageX:e.touches[0].pageX,pageY:e.touches[0].pageY})},touchMove=function(e){handleMousemove({pageX:e.touches[0].pageX,pageY:e.touches[0].pageY})},touchEnd=function(e){handleMouseup({pageX:e.touches[0].pageX,pageY:e.touches[0].pageY})},addListeners=function(e){e?(body$$1.addEventListener("mousedown",handleMousedown),body$$1.addEventListener("mousemove",handleMousemove),body$$1.addEventListener("mouseup",handleMouseup),body$$1.addEventListener("touchstart",touchDown,!1),body$$1.addEventListener("touchmove",touchMove,!1),body$$1.addEventListener("touchend",touchEnd,!1)):window.addEventListener("resize",handleResize)},drawSpiral=function(){for(var e=0,t=0,r=1,n=1,o=imgsLoaded,i=0,a=0;i<o;){for(;2*e*r<n&&!(a>=imgsLoaded);)e+=r,drawImage(a,e,t),a++;for(;2*t*r<n&&!(a>=imgsLoaded);)t+=r,drawImage(a,e,t),a++;if(a>=imgsLoaded)break;r=-1*r,n+=1,i++}},drawImage=function(e,t,r){t*=.3,r*=.3,textureCtx.save(),textureCtx.translate(t*width+x*width,r*width+y*height),dataSet[e].area={left:t,top:r,right:t+dataSet[e].imageData.width/width,bottom:r+dataSet[e].imageData.height/height},textureCtx.drawImage(dataSet[e].imageData,0,0,dataSet[e].imageData.width,dataSet[e].imageData.height),textureCtx.restore()},initApp=function(){loadData().then(loadImages,logError),loadTexture()},loadData=function(){return new Promise(function(e,t){var r=new XMLHttpRequest;r.open("GET","../data/data.json",!0),r.onload=function(){200===r.status?e(JSON.parse(r.responseText)):t(Error(r.statusText))},r.onerror=function(){t(Error("Network Error"))},r.send()})},logError=function(e){return console.log(e)},initData=function(e){dataSet=e,imgsQty=e.length,dataSet.forEach(function(e,t){e.slug=slugify$1(e.title),e.area={left:0,top:0,right:0,bottom:0},body$$1.appendChild(modalBuilder(e))})},initModalAndRouter=function(){Modal(),(new Router).dispatch().extendRoute("#modal/:modalId",function(e,t){var r=dataSet.find(function(t){return t.slug===e});if(r&&(one('[data-title="'+r.slug+'"] h2').textContent=r.title,one('[data-title="'+r.slug+'"] article').innerHTML=r.text,r.media)){var n=img({src:r.media});one('[data-title="'+r.slug+'"] article').insertBefore(n,one('[data-title="'+r.slug+'"] article').firstChild)}})},loadImages=function t(e){e&&(initData(e),initModalAndRouter());var r=new Image;r.onload=function(e){dataSet[imgsLoaded].imageData=e.target,imgsLoaded++,imgsLoaded<imgsQty&&t(),1===imgsLoaded&&addListeners(!0)},r.src=dataSet[imgsLoaded].image},loadTexture=function(){var e=new Image;e.onload=function(){texturePattern=textureCtx.createPattern(e,"repeat"),fillTexture(!0),render()},e.src="img/texture.jpg"},fillTexture=function(e){e&&(textureCtx.fillStyle=texturePattern),textureCtx.fillRect(-(x*width),-(y*height),width,height)},render=function r(){requestAnimationFrame(r),renderTexture(),drawSpiral()},renderTexture=function(){x+=.1*(dx-x),y+=.1*(dy-y),textureCtx.save(),textureCtx.translate(x*width,y*height),fillTexture(),textureCtx.restore()},texturePattern=void 0,imgsQty=void 0,dataSet=void 0,imgsLoaded=0,images=[],width=void 0,height=void 0,grabbing=!1,dx=0,dy=0,x=0,y=0,mx=void 0,my=void 0,clickTime=void 0;handleResize(),addListeners(),initApp();